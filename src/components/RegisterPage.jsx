            ...
            <div className="w-100">
              <Form>
                <Form.Group className="mb-3" controlId="formEmail">
                  ...
                  <Form.Control type="text" placeholder={t('login.enter-email')} className="form-control-custom" />
                </Form.Group>
                <Form.Label>{t('login.password')}</Form.Label>
                <Form.Group className="mb-3 d-flex align-items-center position-relative" controlId="formPassword">
                  <Form.Control type={showPassword ? 'text' : 'password'} placeholder={t('login.enter-password')} className="form-control-custom" />
                ...
                <Form.Group className="mb-3 d-flex align-items-center position-relative" controlId="formPassword">
                  <Form.Control type={showPassword ? 'text' : 'password'} placeholder="Confirm Password" className="form-control-custom" />
                  <span className="position-absolute eye-icon" onClick={togglePasswordVisibility}>
                    {showPassword ? <FaEyeSlash /> : <FaEye />}
                  </span>
                </Form.Group>
                <Form.Group className="mb-3" controlId="formCourse">
                  ...
                  <Form.Control type="text" placeholder="Enter Course Name" className="form-control-custom" />
                </Form.Group>
                <Form.Group className="mb-3" controlId="formGrade">
                  <Form.Label>Grade Assigned</Form.Label>
                  <Form.Control type="text" placeholder="Enter Grade Assigned" className="form-control-custom" />
                </Form.Group>
              ...
              {currentStep !== 6 ? (
                currentStep !== 4 && currentStep !== 5 ? (
                  <Button onClick={handleNextStep} className="navigation-button">
                    <FaArrowCircleRight style={{ width: '40px', height: '40px' }} />
                  </Button>
                ) : (
                  <div></div>
                )
